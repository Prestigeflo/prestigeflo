...
const faqs = [
  ...
  { q: "What industries do you serve?", a: "Service businesses, professional firms, agencies, e-commerce operators, and high-ticket sales teams. If you have repeatable operations, we can automate them." },
